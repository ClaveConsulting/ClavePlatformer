...
export class LeaderboardScene extends Phaser.Scene {
    ...
    public create() {
        ...
        leaderboard = new Leaderboard(
            this, windowWidth / 2, windowHeight / 2, this.currentPlayer,
        );
        ...
        if (!this.fromMenu) {
            ...
            this.button = new MenuButton(
                leaderboard.frame.getCenter().x, leaderboard.frame.y + leaderboard.frame.height / 2 - 100, "Back to menu", () => {
                    if (!!selectedLevel) {
                        this.scene.pause();
                        this.scene.launch(
                            selectedLevel, { fromLeaderboard: true },
                        );
                        this.scene.setVisible(false);
                        this.menu.destroy();
                    }
                }, this, NES_Button.A, Phaser.Input.Keyboard.KeyCodes.SPACE,
            );
        ...
        this.menu = new NavMenu(
            [this.button], MenuDirection.Horizontal, this,
        );
    }
