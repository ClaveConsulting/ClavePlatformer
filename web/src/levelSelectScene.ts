...
import ntnuEasyThumbnail from "../assets/ntnueasy/ntnuEasyThumbnail.png";
...
export class LevelSelectScene extends Phaser.Scene {
    ...
    public preload() {
        ...
        this.load.image("ntnueasy", ntnuEasyThumbnail);
    }
    ...
    public create() {
        ...
        const ntnuImage = new MenuImage(
            levelSelectMenuFrame.getCenter().x - 520,
        ...
        const ntnuEasyImage = new MenuImage(
            levelSelectMenuFrame.getCenter().x,
            levelSelectMenuFrame.getCenter().y,
            "ntnueasy",
            IMAGESCALE,
            () => {
                setSelectedLevel("ntnueasy");
                this.scene.launch("ntnueasy");
                this.scene.pause();
                levelSelectText.destroy();
            },
            this
        ...
        new NavMenu(
            [ntnuImage, ntnuEasyImage, uioImage],
